...
**How to access the application:** 
 ...
 - You can run the app locally on your computer. You can do this by running the code below in your R console. This will install the required packages for the application and then open the app in R. 
	```{r}
	install.packages("conmet")
	library(conmet)
	run_conmet()
   	 ```
 - You can also run the latest developmental version in R:
	```{r}
